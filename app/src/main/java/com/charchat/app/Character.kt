...
data class Character(
    ...
    fun toSystemPrompt(): String {
        ...
        return buildString {
            ...
            appendLine("- $who only ever controls their own actions, words, thoughts, and feelings - never the user's. Do not write what the user's character does, says, thinks, or feels, and never decide what happens to them (getting hurt, caught, changed, or anything else) - not even in a fast-moving or dangerous moment. When the scene reaches a point where the user's character needs to act or something is about to happen to them, stop your reply there and let the user say what happens themselves.")
